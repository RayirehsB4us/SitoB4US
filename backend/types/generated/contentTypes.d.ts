...
export interface ApiBlogPostBlogPost extends Schema.CollectionType {
  ...
  attributes: {
    ...
    > &
      Attribute.Private;
    dataPublicazione: Attribute.Date;
    descrizione: Attribute.Text & Attribute.Required;
    immagine: Attribute.Media<'images'>;
    publishedAt: Attribute.DateTime;
    slug: Attribute.UID<'api::blog-post.blog-post', 'titolo'>;
    tempoLettura: Attribute.Integer & Attribute.DefaultTo<5>;
...
export interface ApiHomeHome extends Schema.SingleType {
  ...
  attributes: {
    ...
    introDescription: Attribute.RichText;
...
export interface ApiJobPositionJobPosition extends Schema.CollectionType {
  ...
  attributes: {
    attiva: Attribute.Boolean & Attribute.DefaultTo<true>;
    createdAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
    ...
    publishedAt: Attribute.DateTime;
    reparto: Attribute.String;
    requisiti: Attribute.RichText;
    slug: Attribute.UID<'api::job-position.job-position', 'titolo'>;
    tipologia: Attribute.Enumeration<
...
export interface ApiServizioServizio extends Schema.CollectionType {
  ...
  attributes: {
    ...
    > &
      Attribute.Private;
    descrizione: Attribute.Text & Attribute.Required;
    icona: Attribute.String & Attribute.Required;
    ordine: Attribute.Integer & Attribute.DefaultTo<0>;
    publishedAt: Attribute.DateTime;
...
export interface ApiTeamMemberTeamMember extends Schema.CollectionType {
  ...
  attributes: {
    ...
    ordine: Attribute.Integer & Attribute.DefaultTo<0>;
    publishedAt: Attribute.DateTime;
    ruolo: Attribute.String & Attribute.Required;
    updatedAt: Attribute.DateTime;
    updatedBy: Attribute.Relation<
      'api::team-member.team-member',
      'oneToOne',
